...
test('Apply Stock Dealer license with valid data', async ({ page }) => {
  ...
  await page.locator('div').filter({ hasText: /^Stock Dealer$/ }).nth(1).click();
  ...
  await page.locator('form-field-wrapper').filter({ hasText: 'Stock Dealer Type Select Type' }).getByRole('combobox').selectOption('Trading Member');
  ...
  await page.getByRole('combobox').nth(1).selectOption('Sri Lanka');
  ...
  await page.locator('form-field-wrapper').filter({ hasText: 'State whether the Applicant' }).getByPlaceholder('Enter Nature of Business').click();
  await page.locator('form-field-wrapper').filter({ hasText: 'State whether the Applicant' }).getByPlaceholder('Enter Nature of Business').fill('Test sttsts tstst stts ststst ststst ststts');
  ...
  await page.locator('subsection').filter({ hasText: 'Ultimate Holding CompanyIf' }).getByPlaceholder('Enter Nature of Business').click();
  await page.locator('subsection').filter({ hasText: 'Ultimate Holding CompanyIf' }).getByPlaceholder('Enter Nature of Business').fill('Test sttsts tstst stts ststst ststst ststts');
  ...
  await page.locator('field-group').filter({ hasText: 'Registered Office Address' }).getByRole('combobox').selectOption('Sri Lanka');
  await page.getByRole('button', { name: '+ Add Field' }).first().click();
  await page.getByRole('textbox', { name: 'Name', exact: true }).click();
  await page.getByRole('textbox', { name: 'Name', exact: true }).fill('Sasindu rashmika');
  await page.getByRole('button', { name: '+ Add Field' }).click();
  await page.getByRole('textbox', { name: 'Name of Shareholder' }).click();
  await page.getByRole('textbox', { name: 'Name of Shareholder' }).fill('Sasindu rashmika');
  ...
  await page.locator('.ng-untouched > .text-end > .bi').click();
  ...
  await page.locator('subsection').filter({ hasText: 'Are the Directors of the Applicant, functioning in the capacity of Directors of' }).getByRole('button').click();
  await page.getByRole('textbox', { name: 'Enter Name of The Company' }).click();
  await page.getByRole('textbox', { name: 'Enter Name of The Company' }).fill('Company A');
  await page.locator('subsection').filter({ hasText: 'Are the Directors of the Applicant, also Directors of the Holding Company/' }).getByRole('button').click();
  await page.getByRole('row', { name: '1 ' }).getByPlaceholder('Enter Name of The Company').click();
  await page.getByRole('row', { name: '1 ' }).getByPlaceholder('Enter Name of The Company').fill('Company B');
  await page.locator('subsection').filter({ hasText: 'Are the Directors of the Applicant, shareholders of Listed Companies?Please' }).getByRole('button').click();
  await page.getByRole('row', { name: '1 ' }).getByPlaceholder('Enter Name of The Company').click();
  await page.getByRole('row', { name: '1 ' }).getByPlaceholder('Enter Name of The Company').fill('Company C');
  await page.locator('subsection').filter({ hasText: 'Are the Directors of the Applicant, directors of another company which has also' }).getByRole('button').click();
  await page.getByRole('row', { name: '1 ' }).getByPlaceholder('Enter Name of The Company').click();
  await page.getByRole('row', { name: '1 ' }).getByPlaceholder('Enter Name of The Company').fill('Company D');
  await page.getByRole('button', { name: '+ Add Field' }).click();
  await page.getByRole('row', { name: '1 ' }).getByPlaceholder('Enter Name of The Company').click();
  ...
  await selectRadio(page, 'renew its licence as required by SEC rules', 0);
