...
test('Apply Credit Rating Agency license with valid data', async ({ page }) => {
  ...
  await page.locator('section-card').filter({ hasText: 'Section AGeneral' }).getByPlaceholder('Enter Name').fill('Brandon Stark');
  ...
  await page.locator('subsection').filter({ hasText: 'Contact Person Information' }).getByPlaceholder('Enter Email Address').fill('stark@mail.com');
  await page.getByRole('textbox', { name: 'Enter Phone Number' }).click();
  await page.getByRole('textbox', { name: 'Enter Phone Number' }).fill('77564789');
  await page.getByRole('textbox', { name: 'Enter Organization Name' }).click();
  await page.getByRole('textbox', { name: 'Enter Organization Name' }).fill('New Sakura Pvt Ltd');
  ...
  await page.locator('section-card').filter({ hasText: 'Section BCertificate' }).getByPlaceholder('Enter City').click();
  await page.locator('section-card').filter({ hasText: 'Section BCertificate' }).getByPlaceholder('Enter City').fill('Colombo');
  ...
  await page.locator('section-card').filter({ hasText: 'Section BCertificate' }).getByPlaceholder('Enter Postal Code').fill('12500');
  ...
  await page.getByRole('textbox', { name: 'Write..', exact: true }).fill('Test test test test');
  ...
  await page.locator('field-group').filter({ hasText: 'Registered Office Address' }).getByPlaceholder('Enter Postal Code').fill('N/A');
  ...
  await page.getByRole('textbox', { name: 'Name', exact: true }).fill('N/A');
  await page.getByRole('textbox', { name: 'Name of Shareholder' }).click();
  await page.getByRole('textbox', { name: 'Name of Shareholder' }).fill('Kusal Silva');
  ...
  // await page.locator('div:nth-child(4) > subsection > .pt-4 > table-entry-section-content > div > .table-wrapper > .fields-entry-table > tbody > tr > .text-end > .bi').click();
  await page.locator('.pt-4.p-4 > table-entry-section-content > div > .table-wrapper > .fields-entry-table > tbody > tr > .text-end > .bi').click();
